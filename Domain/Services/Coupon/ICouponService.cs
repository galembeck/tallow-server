...
public interface ICouponService
{
    ...
    Task<Coupon> CreateAsync(string code, decimal discountPercentage, string? actorId = null, CancellationToken cancellationToken = default);
    Task<Coupon> UpdateAsync(string id, string code, decimal discountPercentage, string? actorId = null, CancellationToken cancellationToken = default);
